                                ...
                                <div className='flex flex-col gap-4 border p-1'>
                                    ...
                                    <div className='md:w-5/6 w-11/12 mx-auto flex flex-col gap-4'>
                                        ...
                                        <div className='flex justify-between items-center gap-4'>
                                            ...
                                            {Object.values(singleInvestment).length !== 0 && <div className='md:text-[0.95rem] text-sm'>{moment(singleInvestment.createdAt).format('DD-MM-yyyy')} / {moment(singleInvestment.createdAt).format('h:mma')}</div>}
                                        </div>
                                        <div className='flex justify-between items-center gap-4'>
