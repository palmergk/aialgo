...
const SetReferralModal = ({ closeView }) => {
    ...
    const SetReferalBonus = async () => {
        ...
        setLoading(true)
        try {
            const response = await UserPutApi(Apis.admin.update_admin_store, { referral_bonus_percentage: amt })
    ...
    return (
        <ModalLayout closeView={closeView} toggler={toggler}>
            <div className='max-w-md h-fit mx-auto bg-white rounded-lg overflow-hidden relative py-5' ref={toggler}>
                ...
                <div className='md:text-xl text-lg uppercase text-center font-bold border-b w-full'>set referral bonus</div>
