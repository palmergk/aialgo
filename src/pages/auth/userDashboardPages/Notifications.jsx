...
const Notifications = () => {
    ...
    const perPage = 6
    const totalPages = Math.ceil(notis.length / perPage)
    const startIndex = (currentPage - 1) * perPage
    const currentNotis = notis.slice(startIndex, startIndex + perPage)
                ...
                <div className='text-black flex flex-col md:w-full w-11/12 mx-auto'>
                    <div className='flex justify-between items-center md:px-2 md:pt-3 pt-5'>
                        ...
                        <div className='relative'>
                            {dataLoading ?
                                <div className='md:w-5 md:h-5 w-7 h-7 rounded-full bg-slate-300 animate-pulse'></div>
                                :
